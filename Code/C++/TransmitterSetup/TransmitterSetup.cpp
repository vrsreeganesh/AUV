...
void TransmitterSetup(TransmitterClass* transmitter_fls,
    ...
    transmitter_fls->azimuthal_beamwidth  = azimuthal_beamwidth;   // assigning azimuth-beamwidth
    transmitter_fls->elevation_beamwidth  = elevation_beamwidth;   // assigning elevation-beamwidth
