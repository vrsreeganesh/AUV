...
# setting paths
tensor_fls          = "/Users/vrsreeganesh/Documents/GitHub/AUV/Code/C++/Assets/ULA_fls_cartesianImage.pt"
...
plt.imshow(torch.imag(tensor_fls), 
           cmap='viridis', 
           interpolation='nearest')
...
# printing
image_fls = torch.abs(tensor_fls).unsqueeze(0).unsqueeze(0).tile(1,3,1,1)
print(f"image_fls.shape = {image_fls.shape}");
